...
class _ChamaDetailBody extends ConsumerWidget {
  ...
  const _ChamaDetailBody({required this.chama, required this.chamaId});
              ...
              actions: [
                if (isOwner) ...[
                  ...
                  IconButton(
                    ...
                    onPressed: () => context.push('/chamas/$chamaId/settings'),
                  ),
                ],
            ...
            if (projectsState.isLoading)
              ...
              SliverToBoxAdapter(
                child: _EmptyProjects(
                  isOwner: isOwner,
                  onCreate:
                      () => context.push('/chamas/$chamaId/projects/create'),
                ),
              )
            else
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (_, i) => Padding(
                      ...
                      child: ProjectCard(project: projectsState.projects[i]),
                    ),
...
class _EmptyProjects extends StatelessWidget {
  ...
  const _EmptyProjects({required this.isOwner, required this.onCreate});
